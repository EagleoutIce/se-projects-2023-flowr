...
%     };
   ...
   \node[above left=2.5mm,yshift=-.65mm,scale=.2] (@) at(current page.south east) {\href{https://github.com/EagleoutIce/tikzpingus}{\usebox\HappyPingu}};
   \node[above right=2.5mm,opacity=.55,scale=.2] at(current page.south west) {\href{https://www.uni-ulm.de/in/sp/}{\includegraphics[height=\dimexpr0.7\ht\HappyPingu+0.7\dp\HappyPingu]{data/sp.pdf}}};
\end{tikzpicture}
\end{frame}
