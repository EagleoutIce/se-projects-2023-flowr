...
\begin{tikzpicture}
   ...
   \coordinate (cursor-pos) at ([xshift=1.65mm,yshift=2mm]F2.south west);
   \draw[Cursor,rotate around={-30:(cursor-pos)}]  [rounded corners=2.25pt] (cursor-pos)  [rounded corners=2.25pt] -- ++(4pt,-9.5pt) [rounded corners=2pt] -- ++(-4pt,3pt) [rounded corners=2.25pt]-- ++(-4pt,-3pt) -- cycle;
   \node[below right,xshift=1.25mm,Hover-Over,minimum width=1.25cm,minimum height=6mm] (hoverover) at(cursor-pos) {%
